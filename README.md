# @taktikorg/odio-animi

[![npm](https://img.shields.io/npm/v/@taktikorg/odio-animi)](https://www.npmjs.com/package/@taktikorg/odio-animi) ![Supports Android, iOS, web, macOS and Windows](https://img.shields.io/badge/platforms-android%20%7C%20ios%20%7C%20web%20%7C%20macos%20%7C%20windows-lightgrey.svg) ![MIT License](https://img.shields.io/npm/l/@taktikorg/odio-animi.svg)

[![JavaScript tests](https://github.com/taktikorg/odio-animi/workflows/JavaScript%20tests/badge.svg)](https://github.com/taktikorg/odio-animi/actions?query=workflow%3AJavaScript%20tests) [![iOS build](https://github.com/taktikorg/odio-animi/workflows/iOS%20build/badge.svg)](https://github.com/taktikorg/odio-animi/actions?query=workflow%3AiOS%20build) [![Android build](https://github.com/taktikorg/odio-animi/workflows/Android%20build/badge.svg)](https://github.com/taktikorg/odio-animi/actions?query=workflow%3AAndroid%20build)
...
```bash
npm install @taktikorg/odio-animi
```
```bash
yarn add @taktikorg/odio-animi
```
...
```js
import { SafeAreaProvider } from '@taktikorg/odio-animi';
...
```js
import { SafeAreaView } from '@taktikorg/odio-animi';
...
```js
import { useSafeAreaInsets } from '@taktikorg/odio-animi';
...
```js
import { SafeAreaInsetsContext } from '@taktikorg/odio-animi';
...
```js
import mockSafeAreaContext from '@taktikorg/odio-animi/jest/mock';

jest.mock('@taktikorg/odio-animi', () => mockSafeAreaContext);
```
